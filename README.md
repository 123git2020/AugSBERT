...
The strategy for bm25 sampling is different from the elasticsearch used in the original paper. Elasticsearch may have timeout problem adn new strategy is more efficient but maintains accuracy.
